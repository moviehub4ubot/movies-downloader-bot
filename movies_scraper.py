...
def search_movies(query):
    ...
    website = BeautifulSoup(requests.get(f"https://www.filmyzilla.cn.com/?s={query.replace(' ', '+')}").text, "html.parser")
...
def get_movie(query):
    ...
    if movie_page_link:
        ...
        final_links = {}
        for i in links:
            url = f"https://www.filmyzilla.cn.com/?api={api_key}&url={i['href']}"
